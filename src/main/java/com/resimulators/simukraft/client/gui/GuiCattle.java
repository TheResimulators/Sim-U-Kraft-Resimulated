...
public class GuiCattle extends GuiScreen{
    private TileCattle tileCattle;
    ...
    public GuiCattle(TileCattle tileCattle){
        this.tileCattle = tileCattle;
    }
    ...
    public void initGui(){
        ...
        if (tileCattle.getHired())buttonList.get(0).enabled = false;
        ...
        List<String> names = (tileCattle).getnames();
        for (int id: (tileCattle).getSims())
        {
