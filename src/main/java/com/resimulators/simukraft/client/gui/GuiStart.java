...
public class GuiStart extends GuiScreen{
    ...
    public void initGui() {
        ...
        buttonList.add(button2 = new GuiButton(2,width/2 - button_width/2,height/3 + 40,button_width,button_height,"Creative"));
        buttonList.add(button3 = new GuiButton(3,width/2 - button_width/2,height/3 + 90,button_width,button_height,"Do not run"));
        super.initGui();
    }
