...
public class PacketHandler {
    ...
    public static void init() {
        ...
        INSTANCE.registerMessage(MinerUpdateDataHandler.class,MinerUpdateDataPacket.class,31,Side.SERVER);
        INSTANCE.registerMessage(UpdateClientFactionHandler.class,UpdateClientFactionPacket.class,32,Side.CLIENT);
        INSTANCE.registerMessage(ClientUpdateMinerHandler.class,ClientUpdateMIningPacket.class,33,Side.SERVER);
    }
